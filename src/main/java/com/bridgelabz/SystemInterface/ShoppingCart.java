...
public class ShoppingCart {
    public static void main(String[] args) {
        ...
        // Adding products
        cart.addProduct("Apple", 1.50, 4);
        cart.addProduct("Banana", 0.80, 10);
        cart.addProduct("Orange", 2.00, 3);
        cart.addProduct("Milk", 3.20, 1);
        cart.addProduct("Apple", 1.50, 2);    // Adding more apples
